...
namespace net.r_eg.vsCE.Test.MSBuild
{
    [TestClass]
    public class ParserTest
    {
        ...
        {
            public class Accessor: vsCE.MSBuild.Parser
            {
                public Accessor(): base(new net.r_eg.vsCE.Environment((DTE2)null)) {}
                public Accessor(net.r_eg.vsCE.Environment env): base(env) { }
            }
