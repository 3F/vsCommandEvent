...
{
    /// <summary>
    /// TODO: string format is deprecated... need to restructure
    /// </summary>
    public class DTEOperation
    {
        ...
        public void exec(Events.Types.Command[] commands, bool abortOnFirstError)
        {
            exec(new Queue<DTEPrepared>(commands.Select(i => new DTEPrepared() { name = i.name, args = i.args })), abortOnFirstError);
        }
