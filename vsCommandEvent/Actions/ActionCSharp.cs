...
namespace net.r_eg.vsCE.Actions
{
    ...
    public class ActionCSharp: Action, IAction
    {
        ...
        /// </summary>
        public const string MAIN_CLASS = "vsCommandEvent.CSharpMode";
        ...
        /// </summary>
        protected const string PREFIX_CACHE = "cached_vsce.";
        ...
        /// <param name="cmd">Push net.r_eg.vsCE.Actions.ICommand into user code.</param>
        /// <param name="evt">Push net.r_eg.vsCE.Events.ISolutionEvent into user code.</param>
