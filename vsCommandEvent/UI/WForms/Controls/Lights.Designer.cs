namespace net.r_eg.vsCE.UI.WForms.Controls
{
    partial class Lights
    {
        ...
        {
            this.pRed = new net.r_eg.vsCE.UI.WForms.Controls.Lights.PanelDt();
            this.pYellow = new net.r_eg.vsCE.UI.WForms.Controls.Lights.PanelDt();
            this.pGreen = new net.r_eg.vsCE.UI.WForms.Controls.Lights.PanelDt();
            this.SuspendLayout();
            // 
            // pRed
            // 
